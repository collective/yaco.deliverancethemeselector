...
This product use the plone.app.registry packages to provide a simlpe way to 
 ...
 * `plone.app.registry <http://http://pypi.python.org/pypi/plone.app.registry>`_


Sponsorship
***********

This product was sponsored by "Universidad de Extremadura" 
(`www.unex.es <http://www.unex.es>`_) and Yaco Sistemas 
(`www.yaco.es <http://www.yaco.es`)
